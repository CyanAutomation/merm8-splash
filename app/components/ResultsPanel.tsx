...
const ResultsPanel = forwardRef<ResultsPanelRef, ResultsPanelProps>(
  ({ results, isAnalyzing, analyzeError, onJumpToLine }, ref) => {
    ...
    const copyViolation = (v: Violation, idx: number) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ flex: 1, overflow: 'auto' }}>
          {isAnalyzing ? (
            <div style={{ padding: '12px', color: 'var(--color-accent-primary)', fontSize: '12px' }}>
              ⠋ Analyzing...
            </div>
          ) : analyzeError ? (
            <div
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
              <thead>
                ...
                >
                  <th style={{ padding: '4px 8px', whiteSpace: 'nowrap' }}>Rule</th>
                  <th style={{ padding: '4px 8px' }}>Sev</th>
                  <th style={{ padding: '4px 8px', width: '100%' }}>Message</th>
                  <th style={{ padding: '4px 8px', whiteSpace: 'nowrap' }}>Line</th>
